...
public class HomeUsers extends javax.swing.JFrame implements Runnable{
    ...
    private void setFrameStyle() {
        ...
        setBounds((width - 1550) / 2, (height - 780) / 2, 1550, 780);
    ...
    private void initComponents() {
        ...
        Pan2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Pan2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jtPic, javax.swing.GroupLayout.DEFAULT_SIZE, 1394, Short.MAX_VALUE)
                .addContainerGap())
        );
        Pan2Layout.setVerticalGroup(
            Pan2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(Pan2Layout.createSequentialGroup()
                .addComponent(jtPic, javax.swing.GroupLayout.DEFAULT_SIZE, 693, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//        SplitPane.setRightComponent(pro);
    ...
    private void btLogoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLogoutActionPerformed
        int Click = JOptionPane.showConfirmDialog(null, "Do you want to log out of your account from the system??", "Message",0);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new HomeUsers(detail).setVisible(true);
            }
        });
    }
