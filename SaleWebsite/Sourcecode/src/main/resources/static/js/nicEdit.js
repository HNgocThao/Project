...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : 'nicEditorIcons.gif', //Chèn link ảnh vào
...
var nicUploadButton=nicEditorAdvancedButton.extend({nicURI:"http://mysite.vn/Lib/nicUpload4Share.aspx",addPane:function()
{
...
this.myStatus.setContent('<img src="http://mysite.vn/Lib/Images/ajax-loader.gif" style="float: right; margin-right: 40px;" /><strong>Uploading...</strong><br />Please wait');
this.myForm.submit();
